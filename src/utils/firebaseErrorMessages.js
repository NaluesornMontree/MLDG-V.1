const AUTH_ERROR_MESSAGES = {
  ...
  'auth/weak-password': 'รหัสผ่านสั้นหรือเดาง่ายเกินไป กรุณาตั้งรหัสผ่านอย่างน้อย 8 ตัวอักษร',
  ...
  'auth/invalid-continue-uri': 'ลิงก์ยืนยันอีเมลไม่ถูกต้อง กรุณาติดต่อผู้ดูแลระบบเพื่อตรวจสอบการตั้งค่า Firebase',
  'auth/unauthorized-continue-uri': 'โดเมนของเว็บไซต์นี้ยังไม่ได้รับอนุญาตใน Firebase Authentication กรุณาเพิ่มโดเมนนี้ใน Authorized domains',
