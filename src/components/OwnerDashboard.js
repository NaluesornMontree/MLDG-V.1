...
function OwnerDashboard({ user, userData, handleLogout, onPasswordResetEmailSent }) { 
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-50 font-sans">
      ...
      {/* --- MAIN CONTENT --- */}
      <div className={`min-w-0 flex-1 p-4 ${mobileMenuOpen ? 'pb-[31rem]' : 'pb-28'} transition-all duration-300 md:p-10 md:pb-10 overflow-y-auto flex flex-col justify-start ${sidebarCollapsed ? 'md:ml-24' : 'md:ml-72'}`}>
